...
# Alexa controller namespace constants
...
#------Changes below-----------------------------------------------------
def handle_cover_position(entity, range_delta, range_delta_default):
    data: dict[str, Any] = {ATTR_ENTITY_ID: entity.entity_id}
...
def handle_tilt_position(entity, range_delta, range_delta_default):
    data: dict[str, Any] = {ATTR_ENTITY_ID: entity.entity_id}
...
def handle_fan_speed(entity, range_delta, range_delta_default):
    data: dict[str, Any] = {ATTR_ENTITY_ID: entity.entity_id}
...
def handle_humidifier(entity, range_delta, range_delta_default):
    data: dict[str, Any] = {ATTR_ENTITY_ID: entity.entity_id}
...
def handle_input_number(entity, range_delta):
    data: dict[str, Any] = {ATTR_ENTITY_ID: entity.entity_id}
...
def handle_number(entity, range_delta):
    data: dict[str, Any] = {ATTR_ENTITY_ID: entity.entity_id}
    range_delta = float(range_delta)
    service = number.SERVICE_SET_VALUE
    min_value = float(entity.attributes[number.ATTR_MIN])
...
def handle_vacuum(entity, range_delta):
    data: dict[str, Any] = {ATTR_ENTITY_ID: entity.entity_id}
...
def handle_valve(entity, range_delta, range_delta_default):
    data: dict[str, Any] = {ATTR_ENTITY_ID: entity.entity_id}
    range_delta = int(range_delta * 20) if range_delta_default else int(range_delta)
    service = valve.SERVICE_SET_VALVE_POSITION
...
async def async_api_adjust_range(
    ...
    # Cover Tilt
        ...
        service, data, response_value = handle_tilt_position(entity, range_delta, range_delta_default)

    # Fan speed percentage
    elif instance == f"{fan.DOMAIN}.{fan.ATTR_PERCENTAGE}":
        service, data, response_value = handle_fan_speed(entity, range_delta, range_delta_default)

    # Humidifier target humidity
    elif instance == f"{humidifier.DOMAIN}.{humidifier.ATTR_HUMIDITY}":
        service, data, response_value = handle_humidifier(entity, range_delta, range_delta_default)

    # Input Number Value
    elif instance == f"{input_number.DOMAIN}.{input_number.ATTR_VALUE}":
        service, data, response_value = handle_input_number(entity, range_delta)
        
    # Number Value
    elif instance == f"{number.DOMAIN}.{number.ATTR_VALUE}":
        service, data, response_value = handle_number(entity, range_delta)
        
    # Vacuum Fan Speed
    elif instance == f"{vacuum.DOMAIN}.{vacuum.ATTR_FAN_SPEED}":
        service, data, response_value = handle_vacuum(entity, range_delta)
        
    # Valve Position
    elif instance == f"{valve.DOMAIN}.{valve.ATTR_POSITION}":
        service, data, response_value = handle_valve(entity, range_delta, range_delta_default)
